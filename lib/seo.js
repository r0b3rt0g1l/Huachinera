...
export function buildMetadata({
  ...
  const fullDescription =
    description ||
    `Portal institucional del ${municipalConfig.identidad.nombreOficial}, ${municipalConfig.identidad.estado}. Transparencia, gobierno, turismo y servicios al ciudadano. Administración ${municipalConfig.identidad.administracion}.`;
